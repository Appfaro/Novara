  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[60] flex flex-col items-center justify-between gap-3 border-t border-brand-gray-700 bg-brand-black px-6 py-4 text-sm text-white sm:flex-row">
      <p>
        ...
        <Link href="/cookies" className="underline hover:text-brand-red">
          política de cookies
        </Link>
        .
      </p>
      <button
        onClick={accept}
        className="whitespace-nowrap bg-brand-red px-5 py-2 text-xs font-bold uppercase tracking-widest2 hover:bg-brand-redDark"
      >
        Aceptar
      </button>
    </div>
